...
Examples:
  ...
  python run_segmentation.py --data_root ./data --list_file images.txt \\
    ...
    required.add_argument(
        "--data_root", required=True, help="Root directory containing images"
    )
    required.add_argument(
        "--list_file",
        required=True,
    ...
    required.add_argument(
        "--output_root", required=True, help="Directory to save results"
    )
    ...
    model_group.add_argument(
        "--checkpoint", help="Path to model checkpoint or HuggingFace model ID"
    )
    model_group.add_argument(
        "--device",
    ...
    clipseg_group.add_argument(
        "--text_prompts", nargs="+", help="Text prompts for CLIPSeg segmentation"
    )
    ...
    filtering.add_argument(
        "--max_area", type=int, help="Maximum segment area in pixels"
    )
    filtering.add_argument(
        "--min_score",
        type=float,
    ...
    filtering.add_argument(
        "--filter_labels", nargs="+", help="Only keep segments with these labels"
    )
    filtering.add_argument(
        "--apply_nms",
        action="store_true",
    ...
    output.add_argument(
        "--save_crops", action="store_true", help="Save individual instance crops"
    )
    output.add_argument(
        "--save_viz", action="store_true", help="Save visualization with overlays"
    )
    output.add_argument(
        "--save_original",
        action="store_true",
