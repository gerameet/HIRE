...
def main():
    ...
    if not sam_checkpoint.exists():
        ...
        print(f"   wget https://dl.fbaipublicfiles.com/segment_anything/sam_vit_b_01ec64.pth -P models/")
        return 1
    ...
    print(f"   Image size: {image_np.shape[1]}x{image_np.shape[0]} ({image_np.shape[2]} channels)")
