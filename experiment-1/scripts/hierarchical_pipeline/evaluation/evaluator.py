...
class RetrievalEvaluator(EvaluationTask):
    ...
    def run(self, parts: List[Any]) -> Dict[str, Any]:
        ...
        metrics = {
            ...
            "retrieval_avg_query_ms": (query_time / num_queries * 1000) if num_queries > 0 else 0.0,
...
class ClassificationEvaluator(EvaluationTask):
    ...
    def run(self, parts: List[Any]) -> Dict[str, Any]:
        ...
        for part in valid_parts:
            ...
            total += 1
            is_correct = predicted.lower() == ground_truth.lower() if ground_truth != "unknown" else False
        ...
        metrics = {
            ...
            "classification_avg_ms": (classify_time / total * 1000) if total > 0 else 0.0
        }
