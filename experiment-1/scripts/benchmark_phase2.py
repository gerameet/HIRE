...
def cmd_retrieval(args):
    ...
    precisions = [precision_at_k(res, [query_parts[i]], k=args.top_k) 
                  for i, res in enumerate(all_results)]
    recalls = [recall_at_k(res, [query_parts[i]], k=args.top_k)
               for i, res in enumerate(all_results)]
...
def cmd_classify(args):
    ...
    from hierarchical_pipeline.evaluation.classification import ZeroShotClassifier, accuracy
...
def main():
    ...
    p_retrieval.add_argument("--num-images", type=int, default=10, help="Number of images")
    ...
    p_classify.add_argument("--num-images", type=int, default=10, help="Number of images")
